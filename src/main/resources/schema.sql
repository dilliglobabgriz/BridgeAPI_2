...
CREATE TABLE round (
    ...
    dealerDirection         INTEGER DEFAULT -1,
    declarerDirection       INTEGER DEFAULT -1,
    ...
    contractSuit            INTEGER DEFAULT -1,          -- e.g., 0=C, 1=D, 2=H, 3=S, 4=NT
    contractLevel           INTEGER DEFAULT 0,          -- 1-7
...
CREATE TABLE bid (
    ...
    suit            INTEGER DEFAULT -1,          -- e.g., 0=C, 1=D, 2=H, 3=S, 4=NT (NULL for Pass/Double/Redouble)
    level           INTEGER DEFAULT 0,          -- 1-7 (NULL for Pass/Double/Redouble)
...
CREATE TABLE trick (
    ...
    winningDirection    INTEGER DEFAULT -1,          -- Player direction winning the trick (0-3)
